...
useEffect(() => {
    const fetchOperationCredits = async () => {
      try{
        ...
        console.error('Error fetching operation credits:', error);
      }
  ...
  const cards =[
    {
      ...
      description: 'Enhance your images with AI-powered generative fill.',
      icon: 'auto-fix-high',
    ...
    { 
      ...
      description: 'Restore old or damaged photos using AI technology.',
      icon: 'restore',
      route: '/restore',
...
<View className="p-4">
  <View className='flex-row flex-wrap justify-between mb-6'>
    <Text className='text-2xl font-bold text-gray-800
     dark:text-white'>Welcome {user?.name}!</Text>
     <TouchableOpacity 
     onPress={() => router.push('/credits')} className='flex-row items-center'>
