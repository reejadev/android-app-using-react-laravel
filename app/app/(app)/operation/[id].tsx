...
import {
    View, Image, ActivityIndicator, TouchableOpacity, Alert, Platform, Share,
    Text, StyleSheet, Dimensions, ScrollView, Animated
} from "react-native";
...
export default function OperationDetails() {
                ...
                { text: "Cancel", style: "cancel" },
                {
                    text: "Delete", style: "destructive", onPress: async () => {
                        try {
                            ...
                            Alert.alert("Deleted", "Operation deleted successfully.");
                            router.back();
                        } catch (error) {
    ...
    const saveImage = async () => {
        ...
        try {
            ...
            const fileUri = FileSystem.Paths.document + `generated_image.jpg`;
        ...
        return (
            <SafeAreaView className="flex-1" style={{ backgroundColor: colors.background }}>
                ...
                <View className="flex-1 justify-center items-center p-5">
                    ...
                    <TouchableOpacity className="px-5 py-2.5 rounded-lg"
                        style={{ backgroundColor: colors.primary }}
                        onPress={() => router.back()}>
                        <Text className="text-base font-semibold"
                            style={{ color: colors.text }}>Go Back</Text>
                    </TouchableOpacity>
            ...
            <View className="flex-1 p-4">
                    ...
                    <View className="flex-row items-center mb-3">
                        ...
                        <View className="ml-3 flex-1">
                            <Text className="text-lg font-bold" style={{ color: colors.text }}>
                                {formatOperationType(operation.operation_type)}</Text>
                ...
                <View className="mb-4">
                    ...
                    <View className="flex-row justify-between">
                        ...
                        <View className="absolute bottom-2 left-2 px-2 pu-1 rounded"
                    ...
                    activeOpacity={0.9}>
                        ...
                        <View className="absolute bottom-2 left-2 px-2 py-1 rounded"
                            style={{ backgroundColor: colors.primary }} >
                                <Text className="text-xs font-semibold"
                                style={{ color: colors.text }}
                                >Generated</Text>
...
<View className="flex-row justify-between mb-4">
    <TouchableOpacity className="flex-row items-cneter justify-cneter py-3 rounded-lg flex-[0.48]"
        style={{ backgroundColor: colors.primary }}
        onPress={saveImage}
...
<TouchableOpacity className="flex-row items-center justify-center py-3 rounded-lg
mt-auto"
