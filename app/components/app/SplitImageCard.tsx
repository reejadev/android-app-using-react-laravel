...
const SplitImageCard: React.FC<SplitImageCardProps> = ({
    ...
    const formatterdType = formatOperationType(operationType);
    ...
    return ( 
        ...
        <View style={styles.header}>
            <View style={styles.iconContainer}>
                <MaterialIcons
                    name={getOperationIcon(operationType)}
                    size={24}
                    color={colors.primary}/>
            </View>
            <View style={styles.headerTextContainer}>
                <Text style={[styles.title, {color: colors.text}]}>{formatterdType}</Text>
                    ...
                    {creditsUsed !== undefined && (
                        <View style={styles.creditsContainer}>
                            ...
                            <Text style={[styles.creditsText, 
                                { color: colors.secondaryText }]}>{creditsUsed} credits</Text>
                        </View>
                    )}
                </View>
            </View>
        ...
        <View style={styles.imageContainer}>
           <Image source={{ uri: originalImage}} style={styles.leftImage} 
           resizeMode="cover" />

               <Image source={{ uri: generatedImage}} style={styles.rightImage} 
           resizeMode="cover" />
           ...
           <View style={[styles.imageLabel, styles.originalLabel, {backgroundColor:colors.surface}]}>
            ...
            <View style={[styles.imageLabel, styles.generatedLabel, {
